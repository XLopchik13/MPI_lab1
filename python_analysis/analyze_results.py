...
Вычисляет ускорение и эффективность, строит графики
"""
...
def load_task1_results(results_dir):
    """Загрузка и обработка результатов задачи 1"""
...
def load_task2_results(results_dir):
    """Загрузка и обработка результатов задачи 2"""
...
def plot_task2_results(df, output_dir):
    ...
    # Сравнительный график для всех размеров (один алгоритм)
    for algo in algorithms:
